...
try:
    ...
    def DownloadHistoricalData(df):
        ...
        for i in range(len(df)):
            ...
            #         current_data = current_data.resample('1D').agg({'Open':'first', 'High':'max', 'Low':'min', 'Close':'last', 'Volume':'sum'})
    ...
    pyautogui.alert(text=f'error is {e}', title='Error in stock screener, please check.')
    print(e)
